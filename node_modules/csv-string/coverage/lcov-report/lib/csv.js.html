...
<html lang="en">
<head>
    <title>Code coverage report for lib/csv.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/csv.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94% <small>(94 / 100)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">83.67% <small>(41 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">93.33% <small>(14 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">94% <small>(94 / 100)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; csv.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  if (typeof item != 'string') {
    var s = item.toString();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (s == '[object Object]') {
...
exports.stringify = function (input, sep) {
  ...
  if (Array.isArray(input) &amp;&amp; !Array.isArray(input[0])) {
    ...
    for (var key in input) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (input.hasOwnProperty(key)) {
...
exports.parse = function (input, sep) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (sep === undefined) {
...
<span class="cstat-no" title="statement not covered" >    callback = sep;</span>
<span class="cstat-no" title="statement not covered" >    sep = ',';</span>
  }
  var csv = new Parser(input, sep);
  var fields = csv.Row();
  callback(fields);
...
&nbsp;
exports.createStream = <span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >  return new Streamer(options);</span>
}
&nbsp;
&nbsp;
&nbsp;</pre></td></tr>
