...
<html lang="en">
<head>
    <title>Code coverage report for lib/parser.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/parser.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.15% <small>(98 / 103)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">92.86% <small>(52 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(10 / 10)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.15% <small>(98 / 103)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; parser.js</div>
</div>
<div class="body">
...
function Parser(input, comma) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Parser)) {
<span class="cstat-no" title="statement not covered" >    return new Parser(input, comma);</span>
  }
  this.input = input;
  this.pointer = 0;
  this.linePointer = 0;
...
Parser.prototype.File = function () {
  ...
  while (1) {
    ...
    if (row.length &gt; 0) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.linePointer &amp;&amp; this.pointer !== this.input.length) {
        files.pop();
    ...
    eof = this.EOF();
    if (eof) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.linePointer &amp;&amp; this.pointer !== this.input.length) {
<span class="cstat-no" title="statement not covered" >        files.pop();</span>
<span class="cstat-no" title="statement not covered" >        this.pointer = this.linePointer;</span>
      }
      break;
    }
  }
...
Parser.prototype.LineBreak = function () {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this.input.charAt(this.pointer) === '\r') {
<span class="cstat-no" title="statement not covered" >    this.pointer += 1;</span>
